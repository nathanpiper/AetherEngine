...
```swift
.package(url: "https://github.com/superuser404notfound/AetherEngine", from: "5.6.2")
```
...
Pin to `.upToNextMinor(from: "5.6.2")` for stricter teams that prefer to opt into minor bumps explicitly.
