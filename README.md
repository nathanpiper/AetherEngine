...
```swift
.package(url: "https://github.com/superuser404notfound/AetherEngine", from: "3.13.4")
```
...
Pin to `.upToNextMinor(from: "3.13.4")` for stricter teams that prefer to opt into minor bumps explicitly.
