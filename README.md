...
```swift
.package(url: "https://github.com/superuser404notfound/AetherEngine", from: "5.0.5")
```
...
Pin to `.upToNextMinor(from: "5.0.5")` for stricter teams that prefer to opt into minor bumps explicitly.
